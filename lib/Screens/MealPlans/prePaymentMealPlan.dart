...
class _PrePaymentMealPlanState extends State<PrePaymentMealPlan> {
  ...
  void initState() {
    super.initState();
    concatenatedAddress = widget.shippingAddressLine1 +
        ',\n' +
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                'Menu Package',
                                style: selectedTab.copyWith(fontWeight: FontWeight.w600,fontSize: 15),
                              ),
                              Padding(
                              ...
                              Padding(
                                ...
                                child: Text(
                                    widget.selectedDays.contains("Sun") &&   widget.selectedDays.contains("Sat")  ?
                                    widget.mealPlan.duration.toString() +" day meal plan with weekend" :
                                    widget.mealPlan.duration.toString() +" day meal plan without weekend"
                                    ,
                                    style: selectedTab.copyWith(
                                        fontSize: 14, fontWeight: FontWeight.normal,color: Color(0xFF909090))),
                              ),
                          ...
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Subscription Days', style: selectedTab.copyWith(fontWeight: FontWeight.w600,fontSize: 15)),
                              Padding(
                                  padding: const EdgeInsets.only(left: 10.0,top: 4),
                                  child: Row(
                        ...
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: !hasCoupon ? GestureDetector(
                                  onTap: (){
                                    setState(() {
                                      hasCoupon = true;
                                    });
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                breakDownFields('Delivery Cost', '${widget.afterNoonPrice} USD', false)
                                    :  Container(),

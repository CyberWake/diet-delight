...
class _PrePaymentState extends State<PrePayment> {
  ...
  bool showCouponCodeTF = false;
  final _couponCodeTFController = TextEditingController();
  List<List> couponCodeList;
...
//    }
  ...
  void getCoupons() async {
    couponCodeList = await Api.instance.getCoupons();
  }
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    'Billing Address',
                    style: billingTextStyle.copyWith(fontSize: 18),
                  ),
                ),
                Material(
                ...
                Container(
                  ...
                  child: Material(
                    ...
                    child: GestureDetector(
                      onTap: () => setState(() => showCouponCodeTF = true),
                      child: Container(
                        decoration: BoxDecoration(
//                    boxShadow: [
//                      BoxShadow(color: Color(0x26000000), blurRadius: 5)
                                ...
                                children: [
                                  ...
                                  if (!showCouponCodeTF)
                                    ...
                                    Container(
                                      ...
                                      child: TextField(
                                        controller: _couponCodeTFController,
                                        style: TextStyle(
                                          color: Colors.white,
                                          fontFamily: 'RobotoReg',
                                          fontWeight: FontWeight.bold,

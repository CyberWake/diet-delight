    ...
    return loaded
        ? ListView(
            ...
            children: List.generate(appointments.length, (index) {
              ...
              int packageIndex =  name.contains("SILVER") ? 0 : name.contains("GOLD") ? 2: 1;
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                                  ...
                                  child: FlatButton(
                                      ...
                                      onPressed: () {
                                        Navigator.of(context).push(MaterialPageRoute(
                                            builder: (BuildContext context) => BookConsultation(packageIndex: packageIndex,consultation: consultationData,)));
                                      })),
                            ],
                          ),
                        )),
                    Flexible(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text((consultationData[index].name).toString()),
                        )),
                    dataField(

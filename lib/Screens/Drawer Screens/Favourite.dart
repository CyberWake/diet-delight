                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        foodItem.foodName,
                        style: appBarTextStyle.copyWith(fontSize: 14,fontWeight: FontWeight.w400),
                      ),
                      SizedBox(
                        height: 10,
                      ),
                      Text(
                        foodItem.des,
                        style: appBarTextStyle.copyWith(fontSize: 12,fontWeight: FontWeight.w400,color: Color.fromRGBO(144, 144, 144, 1)),
                      ),
                      SizedBox(
                        height: 4,
                      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Favourites', style: appBarTextStyle),

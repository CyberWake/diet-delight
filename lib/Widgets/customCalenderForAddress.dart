...
class _CustomCalenderForAddressState extends State<CustomCalenderForAddress> {
  ...
  List primaryAddressDaysList = ['2021-02-14', '2021-02-23'];

  List secondayAddressDaysList = ['2021-02-08', '2021-02-09'];
                            ...
                            return Container(
                              ...
                              decoration: withoutDays.contains(i % 7)
                                  ...
                                  : (primaryAddressDaysList.contains(currDay) ||
                                          ...
                                          widget.addressTapList.contains(1)
                                      ? BoxDecoration(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () async {
                                      ...
                                      setState(() {
                                        if (isDateRemoved == false &&
                                          ...
                                          secondayAddressDaysList
                                              .remove(currDay);
                                        } else if (isDateRemoved == true &&
                                            !primaryAddressDaysList
                                                .contains(currDay) &&
                                            !secondayAddressDaysList
                                                .contains(currDay)) {
                                          if (widget.addressTapList
                                                  .contains(0) &&
                                              widget.addressTapList
                                                  .contains(1)) {
                                            _showDialogBox();
                                          } else if (widget.addressTapList
                                              .contains(0)) {
                                            nextSelectedData = currDay;
                                            primaryAddressDaysList
                                                .add(nextSelectedData);
                                            isDateRemoved = false;
                                          } else if (widget.addressTapList
                                              .contains(1)) {
                                            nextSelectedData = currDay;
                                            ...
                                            print(
                                                "primary value is neither 0 or 1");
                                          }
                                        }
                                      });
                                    },
                                    child: Text(
                                      '$dayText',
                                      style: TextStyle(
                                          color: datesWhenBreakChosen
                                                  .contains(currDay)
                                              ? Color.fromRGBO(119, 131, 149, 1)
                                              : withoutDays.contains(i % 7)
                                                  ? Color.fromRGBO(
                                                      119, 131, 143, 1)
                                                  : Colors.black),
                                    ),
